...
/* System core definition and operations */

// 0, OS not supported
// 1, OS supported
#define SYSTEM_SUPPORT_OS		0		// Define if OS is supported

// Bit-band operations for GPIO control
// IO port operation macros
...
// IO port operations, for single IO port only!
...
void MSR_MSP(u32 addr);	// Set stack pointer address
#endif
